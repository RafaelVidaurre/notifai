...
`@raidiant/notifai` 0.1.3 and `@raidiant/notifai-protocol` 0.1.1; their
...
installs the skill from the immutable public tag `v0.1.3`; the underlying
installer source is `RafaelVidaurre/notifai#v0.1.3` (`#` selects a Git ref).
