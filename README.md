...
`@raidiant/notifai` 0.1.4 and `@raidiant/notifai-protocol` 0.1.1; their
...
installs the skill from the immutable public tag `v0.1.4`; the underlying
installer source is `RafaelVidaurre/notifai#v0.1.4` (`#` selects a Git ref).
