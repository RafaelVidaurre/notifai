...
`@raidiant/notifai` 0.1.5 and `@raidiant/notifai-protocol` 0.1.1; their
...
installs the skill from the immutable public tag `v0.1.5`; the underlying
installer source is `RafaelVidaurre/notifai#v0.1.5` (`#` selects a Git ref).
